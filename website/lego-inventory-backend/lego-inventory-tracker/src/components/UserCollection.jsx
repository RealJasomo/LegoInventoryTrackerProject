...
class UserCollection extends Component {
    ...
    addFavorite = (event) => {
        ...
        axios({
            method: 'POST',
            url:`/api/${urlString[0]}/wants?id=`+this.state.favoriteItem,
            headers: {
    ...
    search = (event) => {
        ...
        axios({
            method: 'POST',
            url:`/api/${urlString[0]}/search`,//?name=`+this.state.searchTarget,
            headers: {
                "Authorization": `Bearer ${this.props.auth.token}`,
                "Content-Type": "application/json"
            },
    ...
    addOwned = (event) => {
        ...
        axios({
           ...
           url:`/api/${urlString[0]}/owns?id=`+this.state.ownedItem,
            headers: {
                "Authorization": `Bearer ${this.props.auth.token}`,
                "Content-Type": "application/json"
            },
    ...
    handleUpdateFavorite = () => {
        ...
        axios({
            method: 'POST',
            url:`/api/${urlString}/wants/update`,
            headers: {
                "Authorization": `Bearer ${this.props.auth.token}`,
                "Content-Type": "application/json"
            },
    ...
    handleDelete = (route) => () => {
        ...
        axios({
            method: 'DELETE',
            url:`/api/${urlString}/${route}/delete`,
            headers: {
                "Authorization": `Bearer ${this.props.auth.token}`,
                "Content-Type": "application/json"
            },
